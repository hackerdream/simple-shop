    ...
    <div class="navbar">
      ...
      <div class="navbar-right-container" style="display: flex;">
        <div class="navbar-menu-container">
          ...
          <a href="javascript:void(0)" class="navbar-link" @click="isShow = true" v-if="!isLoginTrue">Login</a>
          <a href="javascript:void(0)" class="navbar-link" v-if="isLoginTrue">{{user}}</a>
          <a href="javascript:void(0)" class="navbar-link" @click="logout" v-if="isLoginTrue">Logout</a>
        ...
        <div class="md-modal modal-msg md-modal-transition md-show" v-if="isShow">
          <div class="md-modal-inner">
            <div class="md-top">
              <div class="md-title">Login in</div>
              <button class="md-close" @click="isShow = false">Close</button>
            </div>
              ...
              <div class="confirm-tips">
                ...
                <ul>
                  <li class="regi_form_input">
                    ...
                    <input type="text" tabindex="1" v-model="username" name="loginname" class="regi_login_input regi_login_input_left" placeholder="User Name"
                      data-type="loginname">
                  </li>
                  <li class="regi_form_input noMargin">
                    <i class="icon IconPwd"></i>
                    <input type="password" tabindex="2" v-model="password" name="password" class="regi_login_input regi_login_input_left login-input-no input_text"
